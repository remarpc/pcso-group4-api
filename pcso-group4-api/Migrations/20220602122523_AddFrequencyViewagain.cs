...
{
    public partial class AddFrequencyViewagain : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"CREATE VIEW [dbo].[FrequencyView] AS
        ...
        {
            migrationBuilder.Sql(@"DROP VIEW [dbo].[FrequencyView];");
        }
    }
}
